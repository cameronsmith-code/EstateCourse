...
import { cleanStaleAdvisorReferences, cleanStaleTrustReferences, cleanStaleLegacyIntentReferences } from '../lib/referentialIntegrity';
  ...
  const initQuestionnaire = useCallback(async (_questionnaireId?: string) => {
    ...
    try {
      ...
      if (stored) {
        ...
        loadedAnswers = cleanStaleLegacyIntentReferences(cleanStaleTrustReferences(cleanStaleAdvisorReferences(loadAnswersFromStorage())));
            ...
            supabase
              ...
              .then(async ({ data: dbQuestionnaire }) => {
                if (dbQuestionnaire) {
                  ...
                  const cleanedSynced = cleanStaleLegacyIntentReferences(cleanStaleTrustReferences(cleanStaleAdvisorReferences(syncedAnswers)));
