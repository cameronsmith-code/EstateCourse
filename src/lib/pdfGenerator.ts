...
export const generatePDF = (formData: FormData) => {
  ...
  addTaskContent('14', 'Gather necessary personal information and Social Insurance Numbers (SIN) from beneficiaries',
    'This is fairly straight forward and can be done in conjunction with Step 13. Ensure safe and secure storage of confidential information, such as SIN numbers.');
  ...
  addTaskContent('31', 'Search the deceased\'s personal files and safety deposit boxes for original documents',
    'This document is designed to help the Estate Trustee(s) in locating the personal files of the deceased.');
  ...
  addTaskContent('35', 'Investigate and list all outstanding debts, mortgages, and lines of credit',
    'Investigating and listing all outstanding debts is a critical fiduciary duty that ensures the net value of the estate is accurately determined before any distribution to beneficiaries occurs. This process requires the Estate Trustee to move beyond personal records and perform a formal verification of all liabilities.\n\nKey steps include:\n1. Formal Verification with Financial Institutions: The Estate Trustee must contact every bank or financial institution where the deceased had dealings to request a comprehensive list of all outstanding liabilities.\n2. Determining if Debts were Life-Insured: If a mortgage or loan had "creditor insurance," the lender may pay off the balance automatically upon receiving proof of death.\n3. Searching for "Hidden" Liabilities: Best practice involves requesting a report from Equifax or TransUnion to identify all credit facilities registered in the deceased\'s name.\n4. Legal Protection via "Advertisement for Creditors": To protect themselves from personal liability, Estate Trustees should publish a formal "Notice to Creditors" in local newspapers.');
  ...
  addTaskContent('58', 'Confirm sufficient funds remain to pay all debts and taxes before any distribution',
    'Confirming that sufficient funds remain to satisfy all obligations is a mandatory fiduciary duty that must be completed prior to any distribution of assets to beneficiaries. This process ensures the estate follows the legal priority of payment, where all outstanding liabilities and taxes must be settled before testamentary gifts can be fulfilled.\n\nKey aspects include:\n• Solvency and Liquidity: The representative must take a comprehensive inventory of all assets and liabilities to determine the estate\'s financial position.\n• Risk of Personal Liability: Distributing assets prematurely is a significant legal risk.\n• Holdbacks and Tax Clearance: It is standard practice to withhold a "holdback" amount until a Tax Clearance Certificate is obtained.');
