...
export const STEPS: Step[] = [
  ...
  },
  {
    ...
    questions: [
      ...
      {
        key: 'hasContingentPoaPersonalCare',
        label: 'Have you named additional or contingent POAs for Personal Care?',
        type: 'radio',
        options: [
          { value: 'yes', label: 'Yes' },
          { value: 'no', label: 'No' },
      ...
      {
        key: 'contingentPoaPersonalCareCount',
        label: 'How many contingent Power(s) of Attorney(ies) for Personal Care have you named?',
        type: 'select',
        options: [
          { value: '1', label: '1' },
          { value: '2', label: '2' },
        ...
        required: false,
        condition: (formData: Record<string, string>) => formData.hasContingentPoaPersonalCare === 'yes',
      },
      {
        key: 'contingentPoaPersonalCare1Name',
        label: 'Contingent POA for Personal Care #1 - Name',
        type: 'text',
        required: false,
        condition: (formData: Record<string, string>) => {
          const count = parseInt(formData.contingentPoaPersonalCareCount || '0');
          return count >= 1;
        },
      },
      {
        key: 'contingentPoaPersonalCare1Relationship',
        label: 'Contingent POA for Personal Care #1 - Relationship to you',
        type: 'text',
        required: false,
        condition: (formData: Record<string, string>) => {
          const count = parseInt(formData.contingentPoaPersonalCareCount || '0');
      ...
      {
        key: 'contingentPoaPersonalCare1Phone',
        label: 'Contingent POA for Personal Care #1 - Phone Number',
        type: 'text',
        required: false,
        condition: (formData: Record<string, string>) => {
          const count = parseInt(formData.contingentPoaPersonalCareCount || '0');
      ...
      {
        key: 'contingentPoaPersonalCare1Email',
        label: 'Contingent POA for Personal Care #1 - Email Address',
        type: 'text',
        required: false,
        condition: (formData: Record<string, string>) => {
          const count = parseInt(formData.contingentPoaPersonalCareCount || '0');
      ...
      {
        key: 'contingentPoaPersonalCare1City',
        label: 'Contingent POA for Personal Care #1 - City of Residence',
        type: 'text',
        required: false,
        condition: (formData: Record<string, string>) => {
          const count = parseInt(formData.contingentPoaPersonalCareCount || '0');
      ...
      {
        key: 'contingentPoaPersonalCare1Country',
        label: 'Contingent POA for Personal Care #1 - Country of Residence',
        type: 'text',
        required: false,
        condition: (formData: Record<string, string>) => {
          const count = parseInt(formData.contingentPoaPersonalCareCount || '0');
      ...
      {
        key: 'contingentPoaPersonalCare2Name',
        label: 'Contingent POA for Personal Care #2 - Name',
        type: 'text',
        required: false,
        condition: (formData: Record<string, string>) => {
          const count = parseInt(formData.contingentPoaPersonalCareCount || '0');
      ...
      {
        key: 'contingentPoaPersonalCare2Relationship',
        label: 'Contingent POA for Personal Care #2 - Relationship to you',
        type: 'text',
        required: false,
        condition: (formData: Record<string, string>) => {
          const count = parseInt(formData.contingentPoaPersonalCareCount || '0');
      ...
      {
        key: 'contingentPoaPersonalCare2Phone',
        label: 'Contingent POA for Personal Care #2 - Phone Number',
        type: 'text',
        required: false,
        condition: (formData: Record<string, string>) => {
          const count = parseInt(formData.contingentPoaPersonalCareCount || '0');
      ...
      {
        key: 'contingentPoaPersonalCare2Email',
        label: 'Contingent POA for Personal Care #2 - Email Address',
        type: 'text',
        required: false,
        condition: (formData: Record<string, string>) => {
          const count = parseInt(formData.contingentPoaPersonalCareCount || '0');
      ...
      {
        key: 'contingentPoaPersonalCare2City',
        label: 'Contingent POA for Personal Care #2 - City of Residence',
        type: 'text',
        required: false,
        condition: (formData: Record<string, string>) => {
          const count = parseInt(formData.contingentPoaPersonalCareCount || '0');
      ...
      {
        key: 'contingentPoaPersonalCare2Country',
        label: 'Contingent POA for Personal Care #2 - Country of Residence',
        type: 'text',
        required: false,
        condition: (formData: Record<string, string>) => {
          const count = parseInt(formData.contingentPoaPersonalCareCount || '0');
      ...
      {
        key: 'contingentPoaPersonalCare3Name',
        label: 'Contingent POA for Personal Care #3 - Name',
        type: 'text',
        required: false,
        condition: (formData: Record<string, string>) => {
          const count = parseInt(formData.contingentPoaPersonalCareCount || '0');
      ...
      {
        key: 'contingentPoaPersonalCare3Relationship',
        label: 'Contingent POA for Personal Care #3 - Relationship to you',
        type: 'text',
        required: false,
        condition: (formData: Record<string, string>) => {
          const count = parseInt(formData.contingentPoaPersonalCareCount || '0');
      ...
      {
        key: 'contingentPoaPersonalCare3Phone',
        label: 'Contingent POA for Personal Care #3 - Phone Number',
        type: 'text',
        required: false,
        condition: (formData: Record<string, string>) => {
          const count = parseInt(formData.contingentPoaPersonalCareCount || '0');
      ...
      {
        key: 'contingentPoaPersonalCare3Email',
        label: 'Contingent POA for Personal Care #3 - Email Address',
        type: 'text',
        required: false,
        condition: (formData: Record<string, string>) => {
          const count = parseInt(formData.contingentPoaPersonalCareCount || '0');
      ...
      {
        key: 'contingentPoaPersonalCare3City',
        label: 'Contingent POA for Personal Care #3 - City of Residence',
        type: 'text',
        required: false,
        condition: (formData: Record<string, string>) => {
          const count = parseInt(formData.contingentPoaPersonalCareCount || '0');
      ...
      {
        key: 'contingentPoaPersonalCare3Country',
        label: 'Contingent POA for Personal Care #3 - Country of Residence',
        type: 'text',
        required: false,
        condition: (formData: Record<string, string>) => {
          const count = parseInt(formData.contingentPoaPersonalCareCount || '0');
      ...
      {
        key: 'contingentPoaPersonalCare4Name',
        label: 'Contingent POA for Personal Care #4 - Name',
        type: 'text',
        required: false,
        condition: (formData: Record<string, string>) => {
          const count = parseInt(formData.contingentPoaPersonalCareCount || '0');
      ...
      {
        key: 'contingentPoaPersonalCare4Relationship',
        label: 'Contingent POA for Personal Care #4 - Relationship to you',
        type: 'text',
        required: false,
        condition: (formData: Record<string, string>) => {
          const count = parseInt(formData.contingentPoaPersonalCareCount || '0');
      ...
      {
        key: 'contingentPoaPersonalCare4Phone',
        label: 'Contingent POA for Personal Care #4 - Phone Number',
        type: 'text',
        required: false,
        condition: (formData: Record<string, string>) => {
          const count = parseInt(formData.contingentPoaPersonalCareCount || '0');
      ...
      {
        key: 'contingentPoaPersonalCare4Email',
        label: 'Contingent POA for Personal Care #4 - Email Address',
        type: 'text',
        required: false,
        condition: (formData: Record<string, string>) => {
          const count = parseInt(formData.contingentPoaPersonalCareCount || '0');
      ...
      {
        key: 'contingentPoaPersonalCare4City',
        label: 'Contingent POA for Personal Care #4 - City of Residence',
        type: 'text',
        required: false,
        condition: (formData: Record<string, string>) => {
          const count = parseInt(formData.contingentPoaPersonalCareCount || '0');
      ...
      {
        key: 'contingentPoaPersonalCare4Country',
        label: 'Contingent POA for Personal Care #4 - Country of Residence',
        type: 'text',
        required: false,
        condition: (formData: Record<string, string>) => {
          const count = parseInt(formData.contingentPoaPersonalCareCount || '0');
      ...
      {
        key: 'contingentPoaPersonalCare5Name',
        label: 'Contingent POA for Personal Care #5 - Name',
        type: 'text',
        required: false,
        condition: (formData: Record<string, string>) => {
          const count = parseInt(formData.contingentPoaPersonalCareCount || '0');
      ...
      {
        key: 'contingentPoaPersonalCare5Relationship',
        label: 'Contingent POA for Personal Care #5 - Relationship to you',
        type: 'text',
        required: false,
        condition: (formData: Record<string, string>) => {
          const count = parseInt(formData.contingentPoaPersonalCareCount || '0');
      ...
      {
        key: 'contingentPoaPersonalCare5Phone',
        label: 'Contingent POA for Personal Care #5 - Phone Number',
        type: 'text',
        required: false,
        condition: (formData: Record<string, string>) => {
          const count = parseInt(formData.contingentPoaPersonalCareCount || '0');
      ...
      {
        key: 'contingentPoaPersonalCare5Email',
        label: 'Contingent POA for Personal Care #5 - Email Address',
        type: 'text',
        required: false,
        condition: (formData: Record<string, string>) => {
          const count = parseInt(formData.contingentPoaPersonalCareCount || '0');
      ...
      {
        key: 'contingentPoaPersonalCare5City',
        label: 'Contingent POA for Personal Care #5 - City of Residence',
        type: 'text',
        required: false,
        condition: (formData: Record<string, string>) => {
          const count = parseInt(formData.contingentPoaPersonalCareCount || '0');
      ...
      {
        key: 'contingentPoaPersonalCare5Country',
        label: 'Contingent POA for Personal Care #5 - Country of Residence',
        type: 'text',
        required: false,
        condition: (formData: Record<string, string>) => {
          const count = parseInt(formData.contingentPoaPersonalCareCount || '0');
