...
export const STEPS: Step[] = [
  ...
  },
  {
    ...
    description: 'Information about credit cards',
    questions: [
      {
      ...
      {
        key: 'client1CreditCard1Institution',
        label: 'What institution do you have a credit card with?',
        type: 'text',
        placeholder: 'Enter institution name',
        required: false,
        condition: (formData) => formData.client1HasCreditCards === 'yes',
      },
      {
        key: 'client1CreditCard1Last4',
        label: 'What are the last 4 digits of the credit card number?',
        type: 'text',
      ...
      {
        key: 'client1HasAdditionalCreditCard1',
        label: 'Do you have any additional credit cards?',
        type: 'radio',
        options: [
          { value: 'yes', label: 'Yes' },
          { value: 'no', label: 'No' },
      ...
      {
        key: 'client1CreditCard2Institution',
        label: 'What institution do you have a credit card with?',
        type: 'text',
        placeholder: 'Enter institution name',
        required: false,
        condition: (formData) => formData.client1HasAdditionalCreditCard1 === 'yes',
      },
      {
        key: 'client1CreditCard2Last4',
        label: 'What are the last 4 digits of the credit card number?',
        type: 'text',
        placeholder: 'Last 4 digits',
        required: false,
      ...
      {
        key: 'client1HasAdditionalCreditCard2',
        label: 'Do you have any additional credit cards?',
        type: 'radio',
        options: [
          { value: 'yes', label: 'Yes' },
      ...
      {
        key: 'client1CreditCard3Institution',
        label: 'What institution do you have a credit card with?',
        type: 'text',
        placeholder: 'Enter institution name',
        required: false,
        condition: (formData) => formData.client1HasAdditionalCreditCard2 === 'yes',
      },
      {
        key: 'client1CreditCard3Last4',
        label: 'What are the last 4 digits of the credit card number?',
        type: 'text',
        placeholder: 'Last 4 digits',
        required: false,
      ...
      {
        key: 'client1HasAdditionalCreditCard3',
        label: 'Do you have any additional credit cards?',
        type: 'radio',
        options: [
          { value: 'yes', label: 'Yes' },
      ...
      {
        key: 'client1CreditCard4Institution',
        label: 'What institution do you have a credit card with?',
        type: 'text',
        placeholder: 'Enter institution name',
        required: false,
        condition: (formData) => formData.client1HasAdditionalCreditCard3 === 'yes',
      },
      {
        key: 'client1CreditCard4Last4',
        label: 'What are the last 4 digits of the credit card number?',
        type: 'text',
        placeholder: 'Last 4 digits',
        required: false,
      ...
      {
        key: 'client1HasAdditionalCreditCard4',
        label: 'Do you have any additional credit cards?',
        type: 'radio',
        options: [
          { value: 'yes', label: 'Yes' },
      ...
      {
        key: 'client1CreditCard5Institution',
        label: 'What institution do you have a credit card with?',
        type: 'text',
        placeholder: 'Enter institution name',
        required: false,
        condition: (formData) => formData.client1HasAdditionalCreditCard4 === 'yes',
      },
      {
        key: 'client1CreditCard5Last4',
        label: 'What are the last 4 digits of the credit card number?',
        type: 'text',
        placeholder: 'Last 4 digits',
        required: false,
      ...
      },
      {
        ...
        label: 'Does your spouse have any credit cards?',
        type: 'radio',
        options: [
          { value: 'yes', label: 'Yes' },
          { value: 'no', label: 'No' },
        ...
        required: false,
        condition: (formData) => ['married', 'common_law'].includes(formData.maritalStatus),
      },
      {
        key: 'client2CreditCard1Institution',
        label: 'What institution does your spouse have a credit card with?',
        type: 'text',
        placeholder: 'Enter institution name',
        required: false,
        condition: (formData) => formData.client2HasCreditCards === 'yes',
      },
      {
        key: 'client2CreditCard1Last4',
        label: 'What are the last 4 digits of the credit card number?',
        type: 'text',
        placeholder: 'Last 4 digits',
        required: false,
      ...
      {
        key: 'client2HasAdditionalCreditCard1',
        label: 'Does your spouse have any additional credit cards?',
        type: 'radio',
        options: [
          { value: 'yes', label: 'Yes' },
          { value: 'no', label: 'No' },
      ...
      {
        key: 'client2CreditCard2Institution',
        label: 'What institution does your spouse have a credit card with?',
        type: 'text',
        placeholder: 'Enter institution name',
        required: false,
        condition: (formData) => formData.client2HasAdditionalCreditCard1 === 'yes',
      },
      {
        key: 'client2CreditCard2Last4',
        label: 'What are the last 4 digits of the credit card number?',
        type: 'text',
        placeholder: 'Last 4 digits',
        required: false,
      ...
      {
        key: 'client2HasAdditionalCreditCard2',
        label: 'Does your spouse have any additional credit cards?',
        type: 'radio',
        options: [
          { value: 'yes', label: 'Yes' },
      ...
      {
        key: 'client2CreditCard3Institution',
        label: 'What institution does your spouse have a credit card with?',
        type: 'text',
        placeholder: 'Enter institution name',
        required: false,
        condition: (formData) => formData.client2HasAdditionalCreditCard2 === 'yes',
      },
      {
        key: 'client2CreditCard3Last4',
        label: 'What are the last 4 digits of the credit card number?',
        type: 'text',
        placeholder: 'Last 4 digits',
        required: false,
      ...
      {
        key: 'client2HasAdditionalCreditCard3',
        label: 'Does your spouse have any additional credit cards?',
        type: 'radio',
        options: [
          { value: 'yes', label: 'Yes' },
      ...
      {
        key: 'client2CreditCard4Institution',
        label: 'What institution does your spouse have a credit card with?',
        type: 'text',
        placeholder: 'Enter institution name',
        required: false,
        condition: (formData) => formData.client2HasAdditionalCreditCard3 === 'yes',
      },
      {
        key: 'client2CreditCard4Last4',
        label: 'What are the last 4 digits of the credit card number?',
        type: 'text',
        placeholder: 'Last 4 digits',
        required: false,
      ...
      {
        key: 'client2HasAdditionalCreditCard4',
        label: 'Does your spouse have any additional credit cards?',
        type: 'radio',
        options: [
          { value: 'yes', label: 'Yes' },
      ...
      {
        key: 'client2CreditCard5Institution',
        label: 'What institution does your spouse have a credit card with?',
        type: 'text',
        placeholder: 'Enter institution name',
        required: false,
        condition: (formData) => formData.client2HasAdditionalCreditCard4 === 'yes',
      },
      {
        key: 'client2CreditCard5Last4',
        label: 'What are the last 4 digits of the credit card number?',
        type: 'text',
        placeholder: 'Last 4 digits',
        required: false,
